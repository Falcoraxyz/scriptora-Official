...
export const DOWNLOAD_VERSIONS = {
    windows: [
        ...
        { label: "Update Patch v1.0.2.1 (EXE)", link: `${R2_DOMAIN}/update_1.0.2.1/Scriptora_1.0.2_x64-setup.exe`, type: "Update" },
        { label: "Windows Installer (MSI)", link: `${R2_DOMAIN}/Scriptora_1.0.2_x64_en-US.msi`, type: "Enterprise" },
        { label: "Update Patch v1.0.2.1 (MSI)", link: `${R2_DOMAIN}/update_1.0.2.1/Scriptora_1.0.2_x64_en-US1.msi`, type: "Update" },
    ],
    macos: [
        { label: "macOS Apple Silicon (M1/M2/M3)", link: `${R2_DOMAIN}/Scriptora_1.0.2_aarch64.dmg`, type: "Recommended" },
        { label: "Update Patch v1.0.2.1 (Apple Silicon)", link: `${R2_DOMAIN}/update_1.0.2.1/Scriptora_1.0.2_aarch64.dmg`, type: "Update" },
        { label: "macOS Intel", link: `${R2_DOMAIN}/Scriptora_1.0.2_x64.dmg`, type: "Legacy" },
        { label: "Update Patch v1.0.2.1 (Intel)", link: `${R2_DOMAIN}/update_1.0.2.1/Scriptora_1.0.2_x64.dmg`, type: "Update" },
    ],
    linux: [
        { label: "Linux Debian/Ubuntu (DEB)", link: `${R2_DOMAIN}/Scriptora_1.0.2_amd64.deb`, type: "Recommended" },
        { label: "Update Patch v1.0.2.1 (DEB)", link: `${R2_DOMAIN}/update_1.0.2.1/Scriptora_1.0.2_amd64.deb`, type: "Update" },
        ...
        { label: "Update Patch v1.0.2.1 (RPM)", link: `${R2_DOMAIN}/update_1.0.2.1/Scriptora-1.0.2-1.x86_64.rpm`, type: "Update" },
    ]
};
